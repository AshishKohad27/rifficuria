...
import ArtistInfoLoader from "@/components/artist/artist-info-loader";
          ...
          <div className="col-span-10 lg:col-span-7 mb-20 lg:mb-22 -mt-16">
            <div className="lg:max-w-[800px]">
              <div className="flex items-center flex-col md:flex-row md:items-end gap-6 md:gap-8">
                {artistProfileData.profile_img_path ? (<img
                  src={artistProfileData.profile_img_url}
                  alt={artistProfileData.name}
                  ...
                  <ul className="w-[458px] lg:w-full mx-auto lg:ml-auto mb-10 lg:mb-7.5 bg-seashell rounded-2xl px-4 py-6 lg:py-8 flex lg:flex-col justify-center items-center lg:gap-[23px]">
                    ...
                    >
                      <h4 className="text-indigo text-2xl font-bold leading-7.5">
                        {artistProfileData.total_ratings ?? 'NA'}
                      </h4>
                    ...
                    >
                      <h4 className="text-indigo text-2xl font-bold leading-7.5">
                        {artistProfileData.avg_ratings ?? 'NA'}
                    ...
                    >
                      <h4 className="text-indigo text-2xl font-bold leading-7.5">
                        {artistProfileData.total_reviews ?? 'NA'}
            ...
            >
              ...
              <article className="h-[100%] overflow-auto cust-scrollbar">
                <p className="text-textColor text-base font-normal px-4 md:px-8">
                  ...
                  &lsquo;Happier Than Ever,&rsquo; the 21-year-old Los Angeles
                  native remains one of the biggest stars to emerge in the 21st
                  century. Since the release of her debut single &lsquo;ocean
                  eyes&rsquo; in 2015, Eilish continues to shatter the ceiling of
                  music with her genre-defying sound. Fast forward from her humble
                  breakout, her album WHEN WE ALL FALL ASLEEP, WHERE DO WE GO?
                  debuted at No. 1 on the Billboard 200 in the U.S as well as 17
                  additional countries around the world upon release in 2019, and
                  was the most streamed album of that year. WHEN WE ALL FALL
                  ASLEEP, WHERE DO WE GO? was written, produced and recorded
                  entirely by Billie Eilish and brother FINNEAS in their childhood
                  home of Los Angeles. Billie Eilish went on to make history as
                  the youngest artist to receive nominations and win in all the
                  major categories at the 62nd GRAMMY® Awards, receiving an award
                  for Best New Artist, Album of the Year, Record of the Year, Song
                  of the Year, and Best Pop Vocal Album. Billie Eilish is also the
                  youngest artist to write and record an official James Bond theme
                  song, &lsquo;No Time To Die.&rsquo; Most recently, Billie Eilish
                  was nominated for four additional awards at the 63rd Annual
                  GRAMMY Awards in 2021, and took home both Record of the Year for
                  &lsquo;everything i wanted,&rsquo; and Best Song Written For
                  Visual Media for &lsquo;No Time To Die.&rsquo; Billie Eilish
                  released her latest single, &lsquo;Your Power,&rsquo; in April
                  2021. */}
                  {artistProfileData.bio ?? "NA"}
                </p>
              </article>
