                        ...
                        <div className="flex flex-col lg:grid grid-cols-12 gap-8">
                            <div className="col-span-12 lg:col-span-8">
                                ...
                                >
                                    ...
                                    <input
                                        className="text-textColor text-base font-bold capitalize rounded-4xl bg-seashell px-5 py-2 flex-grow "
                                        type="text"
                                        id="search_input"
                                    />
                                </form>
                            ...
                            >
                                ...
                                <ul className="hidden lg:flex gap-10 items-center justify-center">
                                    <li className="flex justify-center items-center gap-2 text-textColor">
                                        <span className="text-base font-normal underline">Pop</span>
                                    ...
                                    <li className="flex justify-center items-center gap-2 text-textColor">
                                        <span className="text-base font-normal underline">Rock</span>
                                        <button className="hover:text-coral transition-all">
                                            <svg
                                                className="w-2 h-2"
                                                xmlns="http://www.w3.org/2000/svg"
